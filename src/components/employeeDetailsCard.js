    ...
    <div style={styles.card}>
      ...
      {props.employee.team === "" ? (
        <div>
          ...
          <div style={styles.cardItem}>
              <p style={styles.cardItemLabel}>Date of birth:</p>
              <p style={styles.cardItemValue}>{props.employee.dob}</p>
            </div>
            <div style={styles.cardItem}>
              <p style={styles.cardItemLabel}>Wife:</p>
              <p style={styles.cardItemValue}>{props.employee.wife}</p>
            </div>
              <p style={styles.cardItemLabel}>Father:</p>
              <p style={styles.cardItemValue}>{props.employee.father}</p>
            </div>
            <div style={styles.cardItem}>
              <p style={styles.cardItemLabel}>Mother:</p>
            ...
            <div style={styles.cardItem}>
              <p style={styles.cardItemLabel}>Date of death:</p>
              <p style={styles.cardItemValue}>{props.employee.dod}</p>
            </div>
